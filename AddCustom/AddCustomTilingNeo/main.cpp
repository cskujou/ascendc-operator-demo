...
int32_t main(int32_t argc, char* argv[]) {
    ...
    size_t inputByteSize = 8 * 4096 * sizeof(uint16_t);
    size_t outputByteSize = 8 * 4096 * sizeof(uint16_t);
    ...
    ICPU_RUN_KF(add_custom, blockDim, x, y, z, *reinterpret_cast<AddCustomTilingData*>(tiling));
